...
| Command | TWSettings | set framerate `{num}` | {"opcode":"twsettings_setFramerate","inputs":{"FPS":[4,{"type":4,"num":{num}}]}} |
| Command | TWSettings | set interpolation `{opt}` | {"opcode":"twsettings_setInterpolation","inputs":{"MODE":[10,{"type":1,"opt":{opt}}]}} |
| Command | TWSettings | set stage size `{opt}` | {"opcode":"twsettings_setStageSize","inputs":{"SIZE":[10,{"type":1,"opt":{opt}}]}} |
| Command | TWSettings | set high quality pen `{opt}` | {"opcode":"twsettings_setHighQualityPen","inputs":{"MODE":[10,{"type":1,"opt":{opt}}]}} |
| Command | TWSettings | set clone limit `{num}` | {"opcode":"twsettings_setCloneLimit","inputs":{"LIMIT":[4,{"type":4,"num":{num}}]}} |
| Reporter | TWSettings | current framerate | {"opcode":"twsettings_getFramerate","inputs":{}} |
| Command | TWSettings | custom framerate `{num}` | {"opcode":"twsettings_setCustomFPS","inputs":{"FPS":[4,{"type":4,"num":{num}}]}} |
| Command | TWSettings | toggle turbo mode | {"opcode":"twsettings_toggleTurboMode","inputs":{}} |
| Boolean | TWSettings | turbo mode on? | {"opcode":"twsettings_isTurboMode","inputs":{}} |
| Command | TWSettings | set video transparency `{num}` | {"opcode":"twsettings_setVideoTransparency","inputs":{"LEVEL":[4,{"type":4,"num":{num}}]}} |
| Command | TWSettings | set drag mode `{opt}` | {"opcode":"twsettings_setDragMode","inputs":{"MODE":[10,{"type":1,"opt":{opt}}]}} |